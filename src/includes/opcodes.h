...
typedef enum {
    ...
    PYRO_OPCODE_BINARY_MOD,
    PYRO_OPCODE_BINARY_REM,
    PYRO_OPCODE_BREAK,
    PYRO_OPCODE_CALL_COUNT,
    ...
    PYRO_OPCODE_MAKE_CLOSURE_WITH_DEFAULT_ARGS,
    PYRO_OPCODE_MAKE_ENUM,
    PYRO_OPCODE_MAKE_OBJECT,
    PYRO_OPCODE_MAKE_MAP,
    PYRO_OPCODE_MAKE_SET,
    PYRO_OPCODE_MAKE_STR,
