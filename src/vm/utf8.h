...
// Attempts to read a utf-8-encoded unicode codepoint from [src].
...
// Writes a unicode codepoint to [dst], encoded as utf-8.
// Returns the number of bytes written (between 1 and 4).
// Does not validate that [codepoint] is within the valid range for unicode codepoints.
