...
// pyro_get_method() containing one of:
//
// - PyroNativeFn
// - PyroClosure
//
...
//
// Before calling this function the receiver and the method's arguments should be pushed onto
// the stack. These values (and the return value of the method) will be popped off the stack
// before this function returns.
//
// The called method can set the panic or exit flags so the caller should check
